...
: Node("torque_vectoring_node")
{
    ...
    slip_rl_sub_ = this->create_subscription<std_msgs::msg::Float64>(
        "/vehicle/slip_rl", 10, std::bind(&TorqueVectoringNode::slipRLCallback, this, std::placeholders::_1));

    slip_rr_sub_ = this->create_subscription<std_msgs::msg::Float64>(
        "/vehicle/slip_rr", 10, std::bind(&TorqueVectoringNode::slipRRCallback, this, std::placeholders::_1));
    ...
    traction_controlRR = std::make_shared<TractionControl>(car_params_, 1500.0, 0.0, 0.0, 0.001, 10000.0, 0.15);
    traction_controlRL = std::make_shared<TractionControl>(car_params_, 1500.0, 0.0, 0.0, 0.001, 10000.0, 0.15);
